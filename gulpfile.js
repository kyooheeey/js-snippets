...
const watchFiles = done => {
  ...
  watch('src/assets/scss/**/*.scss').on('change', series( parallel(series(TASK__scss, TASK__css), TASK__imagemin), browserReload ));
  watch('src/ejs/**/*.ejs').on('change',   series( parallel(series(TASK__ejs, TASK__inc), TASK__imagemin), browserReload ));
  watch('src/assets/js/**/*.js').on('change',     series( parallel(series(TASK__webpack, TASK__minjs), TASK__imagemin), browserReload ));
